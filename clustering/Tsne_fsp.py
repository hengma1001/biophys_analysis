...
omm_list = sorted(glob.glob('/gpfs/alpine/bip179/proj-shared/fs-pep.3rd/omm_runs_*'))


# # Embeddings 


model_weight = '/gpfs/alpine/bip179/proj-shared/entk/hyperspace/microscope/experiments_train_fsp/CVAE_exps_6/cvae_weight.h5'
...
cm_tsne = TSNE(n_components=2).fit_transform(cm_predict[::10]) 

# # Saving results 

h5_save = h5py.File('./tsne_fsp.h5', 'w') 
